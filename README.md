...
Soy **Ingeniero Civil Industrial** con una profunda pasión por la tecnología, el análisis de datos y el desarrollo de software. Busco constantemente optimizar procesos e impulsar la toma de decisiones a través de la transformación digital.

- 💼 Actualmente trabajando como **Full Stack Developer** en ValueDev SpA.
- 🤖 Experiencia sólida en investigación y desarrollo de Inteligencia Artificial, enfocada en **LLMs, Fine-Tuning y arquitecturas RAG** (Universidad de Concepción).
- ⚙️ Combino la visión estratégica de la ingeniería industrial con habilidades técnicas avanzadas para crear productos eficientes y de alto valor.
